...
<main>
   ...
   <section class="home-header bg-[#F6F6F6]">
      <a href="" class="h-[calc(100vh-135px)] lg:h-[calc(100dvh+55px)] xl:h-[calc(100dvh+35px)] max-h-[670px] md:max-h-[688px] lg:max-h-[950px] xl:max-h-[1000px] min-h-[550px] md:min-h-[500px] lg:min-h-[550px] xl:min-h-[600px] w-full block relative overflow-hidden">
